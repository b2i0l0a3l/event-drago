      ...
      <div className="flex flex-col gap-8 p-4 overflow-y-auto">
        ...
        <div className="flex flex-col gap-1">
          ...
          <Link
            ...
            className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-muted-foreground"
          >
